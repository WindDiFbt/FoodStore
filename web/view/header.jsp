    ...
    <div class="search-popup">
        <div class="search-popup-container">
            <form action="search" method="post" class="search-form" >
                <input type="search" id="search-form" class="search-field" placeholder="Tên sản phẩm" value="" name="txt" />
                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                            ...
                            <c:if test="${sessionScope.user == null}">
                                <li class="nav-item">
                                    <a class="nav-link me-4 <%= currentPage.endsWith("login.jsp") ? "active" : "" %>" href="view/login">Đăng nhập</a>
                                </li>
                            </c:if>
                            <li class="nav-item">
                                            ...
                                            <div class="dropdown">
                                                <li class="pe-3">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                                        <li><a style="font-size: 13px" class="dropdown-item" href="view/user/user_detail">Tài khoản của tôi</a></li>
                                                        <li><a style="font-size: 13px" class="dropdown-item" href="view/user/listorder">Đơn hàng của tôi</a></li>
                                                        <li><a style="font-size: 13px" class="dropdown-item" href="view/logout"> Đăng xuất</a></li>
                                                    </ul>
                                                </li>
                                            </div>
                                        </c:if>
                                        <li>
                                            <a href="view/user/cart">
                                                <svg class="cart">
